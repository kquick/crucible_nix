...
# Usage:
#   $ nix-build -A blt crucible.nix
#   <generates result link in local director>
#
#   $ nix-build --argstr compiler ghc7103 -A blt crucible.nix
#   <same as above but with compiler version override>
#
#   $ nix-shell -A env crucible.nix
#   nix-shell$ <environment with *all* dependencies>
#
#   $ nix-shell -A blt.env crucible.nix
#   nix-shell$ <environment with blt dependencies>
#
#   $ echo "(import $(pwd)/crucible.nix {}).blt.env" > blt/dir/shell.nix
#   $ cd blt/dir
#   $ nix-shell
#   nix-shell$ <environment with blt dependencies>
